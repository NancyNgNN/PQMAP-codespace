@echo off
REM Report Builder Quick Setup Script for Windows
REM Run this script to install all dependencies and set up Report Builder

echo.
echo ================================================
echo   Report Builder Setup
echo ================================================
echo.

echo [1/2] Installing core packages...
call npm install react-pivottable plotly.js react-plotly.js xlsx jspdf jspdf-autotable

echo.
echo [2/2] Installing TypeScript definitions...
call npm install --save-dev @types/react-pivottable @types/plotly.js
