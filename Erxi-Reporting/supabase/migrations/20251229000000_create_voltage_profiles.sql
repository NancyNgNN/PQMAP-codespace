...
CREATE TABLE IF NOT EXISTS voltage_profiles (
  ...
  selected_meters TEXT[], -- Array of meter IDs
...
-- Create meter_voltage_readings table for storing historical voltage data
...
-- Only admins and operators can insert/update voltage readings
